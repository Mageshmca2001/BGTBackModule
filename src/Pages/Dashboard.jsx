// Enhanced Dashboard.jsx with tooltips enabled and datalabels disabled
...
className="border border-gray-300 rounded-lg px-3 py-2 text-base w-36 focus:ring-2 focus:ring-blue-500"
>
...
className="border border-gray-300 rounded-lg px-3 py-2 w-32 text-sm focus:ring-2 focus:ring-blue-500"
/>
</div>
</div>
</div>
<div className="flex space-x-4 mt-4 md:mt-0">
<div className="bg-primary text-white px-4 py-2 rounded-lg shadow-lg font-semibold">Date: {formattedDate}</div>
<div className="bg-primary text-white px-4 py-2 rounded-lg shadow-lg font-semibold">Time: {formattedTime}</div>
</div>
</div>
...
<StarCard {...data?.presentDay} bgColor="from-emerald-400 to-emerald-600" icon="briefcase" title="General Shift 1" />
<StarCard {...data?.presentDay} bgColor="from-yellow-400 to-yellow-600" icon="sun" title="General Shift 2" />
<StarCard {...data?.presentDay} bgColor="from-indigo-400 to-indigo-600" icon="moon" title="General Shift 3" />
</div>
)}
{selectedRange === 'Week' && (
<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-6">
<StarCard {...data?.presentWeek} bgColor="from-purple-500 to-purple-700" icon="calendarWeek" title={`Present Week: ${getWeekRange(0)}`} />
<StarCard {...data?.previousWeek} bgColor="from-yellow-500 to-yellow-700" icon="calendarWeek" title={`Previous Week: ${getWeekRange(1)}`} />
</div>
)}
{selectedRange === 'Month' && (
<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-6">
<StarCard {...data?.presentMonth} bgColor="from-pink-400 to-pink-600" icon="calendar" title={`Present Month: ${getMonthRangeLabel(0)}`} />
<StarCard {...data?.previousMonth} bgColor="from-orange-400 to-orange-600" icon="calendar" title={`Previous Month: ${getMonthRangeLabel(1)}`} />
</div>
)}
{selectedRange === 'Year' && (
<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-6">
...
<h2 className="text-2xl text-gray-700 font-bold text-center mb-6">Meter Testing Analysis Dashboard</h2>
