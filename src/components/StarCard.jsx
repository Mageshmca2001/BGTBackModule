...
<div className="w-full text-white text-xs font-medium md:text-sm px-4 py-2 rounded shadow-md border border-white hover:bg-gray-600 hover:text-white transition text-left">
