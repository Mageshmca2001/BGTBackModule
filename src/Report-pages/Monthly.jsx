...
className="bg-green-600 text-white px-4 py-2 rounded mt-6 hover:bg-gray-400 mr-2"
>
...
className="bg-green-600 text-white px-4 py-2 rounded mt-6 hover:bg-gray-400"
>
...
<p className="text-gray-500 text-sm font-[poppins] mb-4">Monthly analysis of meter testing</p>
...
<p className="text-2xl font-bold">{totalTested}</p>
</div>
...
<p className="text-2xl font-bold">{totalReworked}</p>
</div>
</div>
</div>
</div>
